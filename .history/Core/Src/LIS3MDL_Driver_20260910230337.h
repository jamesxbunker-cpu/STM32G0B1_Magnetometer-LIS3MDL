 ...
 * ========================================================================= */
#define LIS3MDL_CTRL1_TEMP_EN       (1 << 7)
...
#define LIS3MDL_CTRL2_REBOOT        (1 << 3)
#define LIS3MDL_CTRL2_SOFT_RST      (1 << 2)

/* =========================================================================
 * CTRL_REG3 (0x22) Bit Definitions
 * ========================================================================= */
#define LIS3MDL_CTRL3_LP            (1 << 5)
 ...
 * ========================================================================= */
#define LIS3MDL_CTRL4_OMZ_MASK      (0x07 << 2)   /* Z operative mode */
#define LIS3MDL_CTRL4_OMZ_LP        (0x00 << 2)
#define LIS3MDL_CTRL4_OMZ_MP        (0x01 << 2)
#define LIS3MDL_CTRL4_OMZ_HP        (0x02 << 2)
#define LIS3MDL_CTRL4_OMZ_UHP       (0x03 << 2)
#define LIS3MDL_CTRL4_BDU           (1 << 1)      /* Block data update */
#define LIS3MDL_CTRL4_BLE           (1 << 0)      /* Big/little endian */
 ...
 */
LIS3MDL_Status_t LIS3MDL_ReadRegs(LIS3MDL_Handle_t *dev, uint8_t reg,
